                ...
                @foreach ($tests as $test)
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="course-item bg-light shadow-sm">
                            ...
                            <div class="d-flex justify-content-center border-top">
                                    <a href="{{route('test.detail', ['id'=>base64_encode($test->id)])}}" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="@isset($test->price) border-radius: 30px 0 0 30px;@endisset @unless($test->price) border-radius: 30px @endunless">Read More</a>
                                    @isset($test->price)
                                    <a href="#" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Join Now</a>
                                    @endisset
                            </div>
